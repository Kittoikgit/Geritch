(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero-home__slider")) new swiper_core_Swiper(".hero-home__slider", {
            ...
            pagination: {
                el: ".hero-home__bullets",
                renderBullet: (index, className) => `<span class="${className}">${(index + 1).toString().padStart(2, "0")}</span>`
            },
            on: {}
        });
    }
